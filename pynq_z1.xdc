...
connect_debug_port u_ila_0/probe0 [get_nets [list {count_reg[0]} {count_reg[1]} {count_reg[2]} {count_reg[3]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe1]
set_property port_width 8 [get_debug_ports u_ila_0/probe1]
connect_debug_port u_ila_0/probe1 [get_nets [list {debounce_counter[0]} {debounce_counter[1]} {debounce_counter[2]} {debounce_counter[3]} {debounce_counter[4]} {debounce_counter[5]} {debounce_counter[6]} {debounce_counter[7]}]]
create_debug_port u_ila_0 probe
...
connect_debug_port u_ila_0/probe3 [get_nets [list button_down]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe4]
set_property port_width 1 [get_debug_ports u_ila_0/probe4]
connect_debug_port u_ila_0/probe4 [get_nets [list debounce_counter_en]]
